...
public class CommonProblemController {
    ...
    public ResponseEntity<SubmitsResponseDTO> getSubmitProblem(@PathVariable Long problemId){
        return ResponseEntity.status(HttpStatus.OK).body(commonProblemService.getSubmitProblem(1L, problemId));
    }
}
